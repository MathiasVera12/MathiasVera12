...
Aquí algunos cursos que estoy realizando o completando para fortalecer mis habilidades:

- [x] ✅ **Curso de Flutter & Dart – Udemy**  
  _Estado: Completado_  
  ![Progreso](https://progress-bar.dev/100/?title=Flutter)

- [ ] 🔄 **Curso de Django + Django Rest Framework – Udemy**  
  _Estado: En curso_  
  ![Progreso](https://progress-bar.dev/70/?title=Django%20+%20DRF)

- [ ] 🔄 **React - De cero a experto (Hooks y MERN) – Udemy**  
  _Estado: En curso_  
  ![Progreso](https://progress-bar.dev/50/?title=React)

- [ ] 🔄 **Spring Boot desde cero – OpenBootcamp**  
  _Estado: En curso_  
  ![Progreso](https://progress-bar.dev/35/?title=Spring%20Boot)

- [ ] 🕓 **Clean Architecture en ASP.NET Core – Udemy**  
  _Estado: Próximamente_  
  ![Progreso](https://progress-bar.dev/0/?title=Clean%20Architecture)
